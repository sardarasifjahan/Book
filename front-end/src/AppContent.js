...
import {InventoryGodown} from "./pages/Items/InventoryGodown";
import {InventoryShop} from "./pages/Items/InventoryShop";
...
export const AppContent = ({flag, handleBooleanChange, setFlag}) => {
    ...
    function getRoutesAndElement() {
        return <Routes>
            ...
            <Route path="/item/inventory" element={<InventoryShop/>}/>
            <Route path="/item/godowon" element={<InventoryGodown/>}/>
