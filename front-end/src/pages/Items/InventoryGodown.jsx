...
export const InventoryGodown = () => {
    ...
    async function handleDelete(id, event) {
        ...
        const response = await axios.post(`http://localhost:8777/hesabbook/business/account/delete/${id}`);
    ...
    function fetchAllManageUserData() {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8777/hesabbook/business/account/all');
