                ...
                <Box>
                    <TableContainer component={Paper}>
                        ...
                        >
                            <TableHead>
                                <TableRow>
                                    <StyledTableCellForInvoice align="center">NO</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">ITEMS</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">HSN</StyledTableCellForInvoice>

                                    <StyledTableCellForInvoice align="center">BATCH</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">EXP</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">PACK</StyledTableCellForInvoice>

                                    <StyledTableCellForInvoice align="center">
                                        PRICE/ITEM (₹)
                                    </StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">QTY</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">DISCOUNT</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">TAX</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">AMOUNT (₹)</StyledTableCellForInvoice>
                                    <StyledTableCellForInvoice align="center">Actions</StyledTableCellForInvoice>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {employees.map((employee) => (
                                    <TableRow key={employee.id}>
                                        ...
                                        <StyledTableCellForInvoice align="center">
                                            <CenteredTextField
                                                value={employee.batchNo}
                                                disabled={true}
                                                onChange={(e) =>
                                                    handleInputChange(employee.id, "batchNo", e.target.value)
                                                }
                                            />
                                        </StyledTableCellForInvoice>
                                        <StyledTableCellForInvoice align="center">
                                            <TextField
                                                ...
                                                disabled={true}
                                                onChange={(e) =>
                                                    handleInputChange(employee.id, "expireDate", e.target.value)
                                                }
                                            />
                                        </StyledTableCellForInvoice>
                                        <StyledTableCellForInvoice align="center">
                                            <CenteredTextField
                                                value={employee.packageItems}
                                                disabled={true}
                                                onChange={(e) =>
                                                    handleInputChange(employee.id, "packageItems", e.target.value)
                                                }
                                            />
                                        </StyledTableCellForInvoice>
