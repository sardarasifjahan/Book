...
export const Expense = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await axios.post('http://localhost:8080/hesabbook/expense/save', manageUserObj);
    ...
    async function handleDelete(id, event) {
        const response = await axios.post(`http://localhost:8080/hesabbook/expense/delete/${id}`);
    ...
    function fetchAllManageUserData() {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/hesabbook/expense/all/${loginData.primary_user_id}`);
