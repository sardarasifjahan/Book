...
export const AccountManagementUsers = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await axios.post('http://localhost:8777/hesabbook/manageuser/save', manageUserObj);
    ...
    async function handleDelete(id, event) {
        const response = await axios.post(`http://localhost:8777/hesabbook/manageuser/delete/${id}`);
    ...
    function fetchAllManageUserData() {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8777/hesabbook/manageuser/all');
