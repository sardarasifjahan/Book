...
export const Party = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await axios.post('http://localhost:8080/hesabbook/partner/save', manageUserObj);
    ...
    async function handleDelete(id, event) {
        ...
        const response = await axios.post(`http://localhost:8080/hesabbook/partner/delete/${id}`);
    ...
    /*    const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/hesabbook/manageuser/all/${loginData.primary_user_id}`);
    ...
    function fetchAllManageUserData() {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8080/hesabbook/partner/all');
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/hesabbook/partner/all/${loginData.primary_user_id}`);
    ...
    const handleSave = async () => {
        ...
        const response = await axios.post(`http://localhost:8080/hesabbook/partner/upload/${loginData.primary_user_id}/${loginData.secondary_user_id}`, excelData);
